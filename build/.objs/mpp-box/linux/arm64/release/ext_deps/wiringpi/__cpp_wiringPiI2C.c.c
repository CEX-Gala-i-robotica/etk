# 0 "ext_deps/wiringpi/wiringPiI2C.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "ext_deps/wiringpi/wiringPiI2C.c"
# 48 "ext_deps/wiringpi/wiringPiI2C.c"
...
# 49 "ext_deps/wiringpi/wiringPiI2C.c" 2
...
# 50 "ext_deps/wiringpi/wiringPiI2C.c" 2
...
# 51 "ext_deps/wiringpi/wiringPiI2C.c" 2
...
# 52 "ext_deps/wiringpi/wiringPiI2C.c" 2
...
# 53 "ext_deps/wiringpi/wiringPiI2C.c" 2
...
# 54 "ext_deps/wiringpi/wiringPiI2C.c" 2
...
# 1 "/usr/lib/linux/uapi/arm64/asm/ioctls.h" 1 3 4
...
# 1 "/usr/lib/linux/uapi/arm64/asm/ioctl.h" 1 3 4
# 1 "/usr/include/asm-generic/ioctl.h" 1 3 4
# 2 "/usr/lib/linux/uapi/arm64/asm/ioctl.h" 2 3 4
# 6 "/usr/include/linux/ioctl.h" 2 3 4
# 6 "/usr/include/asm-generic/ioctls.h" 2 3 4
# 2 "/usr/lib/linux/uapi/arm64/asm/ioctls.h" 2 3 4
...
# 55 "ext_deps/wiringpi/wiringPiI2C.c" 2
# 1 "/usr/lib/linux/uapi/arm64/asm/ioctl.h" 1 3 4
# 56 "ext_deps/wiringpi/wiringPiI2C.c" 2

# 1 "ext_deps/wiringpi/wiringPi.h" 1
# 141 "ext_deps/wiringpi/wiringPi.h"

# 141 "ext_deps/wiringpi/wiringPi.h"
extern const char *piModelNames [27] ;
extern const char *piProcessor [ 5] ;
extern const char *piRevisionNames [16] ;
extern const char *piMakerNames [16] ;
extern const int piMemorySize [ 8] ;
# 168 "ext_deps/wiringpi/wiringPi.h"
...
# 213 "ext_deps/wiringpi/wiringPi.h"
...
extern int wiringPiGlobalMemoryAccess(void);
extern int wiringPiUserLevelAccess (void) ;
extern int wiringPiSetup (void) ;
extern int wiringPiSetupSys (void) ;
extern int wiringPiSetupGpio (void) ;
extern int wiringPiSetupPhys (void) ;
extern int wiringPiSetupPinType (enum WPIPinType pinType);
extern int wiringPiSetupGpioDevice(enum WPIPinType pinType);
...
extern int wiringPiGpioDeviceGetFd();
extern void pinModeAlt (int pin, int mode) ;
extern enum WPIPinAlt getPinModeAlt (int pin) ;
...
extern int piBoard40Pin (void) ;
extern int piRP1Model (void) ;
extern int wpiPinToGpio (int wpiPin) ;
extern int physPinToGpio (int physPin) ;
extern void setPadDrive (int group, int value) ;
extern void setPadDrivePin (int pin, int value);
...
extern struct WPIWfiStatus waitForInterrupt2(int pin, int edgeMode, int ms, unsigned long debounce_period_us) ;
extern int wiringPiISR2 (int pin, int edgeMode, void (*function)(struct WPIWfiStatus wfiStatus, void* userdata), unsigned long debounce_period_us, void* userdata) ;
extern int wiringPiISRStop (int pin) ;
extern int waitForInterruptClose(int pin) ;
...
# 58 "ext_deps/wiringpi/wiringPiI2C.c" 2
# 1 "ext_deps/wiringpi/wiringPiI2C.h" 1
# 25 "ext_deps/wiringpi/wiringPiI2C.h"
...
# 26 "ext_deps/wiringpi/wiringPiI2C.h" 2
...
# 31 "ext_deps/wiringpi/wiringPiI2C.h"
extern int wiringPiI2CRead (int fd) ;
extern int wiringPiI2CReadReg8 (int fd, int reg) ;
extern int wiringPiI2CReadReg16 (int fd, int reg) ;
extern int wiringPiI2CReadBlockData (int fd, int reg, uint8_t *values, uint8_t size);
extern int wiringPiI2CRawRead (int fd, uint8_t *values, uint8_t size);

extern int wiringPiI2CWrite (int fd, int data) ;
extern int wiringPiI2CWriteReg8 (int fd, int reg, int data) ;
extern int wiringPiI2CWriteReg16 (int fd, int reg, int data) ;
extern int wiringPiI2CWriteBlockData (int fd, int reg, const uint8_t *values, uint8_t size);
extern int wiringPiI2CRawWrite (int fd, const uint8_t *values, uint8_t size);

extern int wiringPiI2CSetupInterface (const char *device, int devId) ;
extern int wiringPiI2CSetup (const int devId) ;
# 59 "ext_deps/wiringpi/wiringPiI2C.c" 2
# 87 "ext_deps/wiringpi/wiringPiI2C.c"
...
# 120 "ext_deps/wiringpi/wiringPiI2C.c"
int wiringPiI2CRead (int fd)
{
  union i2c_smbus_data data ;

  if (i2c_smbus_access (fd, 1, 0, 1, &data))
    return -1 ;
  else
    return data.byte & 0xFF ;
}
# 137 "ext_deps/wiringpi/wiringPiI2C.c"
int wiringPiI2CReadReg8 (int fd, int reg)
{
  union i2c_smbus_data data;

  if (i2c_smbus_access (fd, 1, reg, 2, &data))
    return -1 ;
  else
    return data.byte & 0xFF ;
}
...
int wiringPiI2CReadReg16 (int fd, int reg)
{
  ...
  if (i2c_smbus_access (fd, 1, reg, 3, &data))
    return -1 ;
  else
...
int wiringPiI2CReadBlockData (int fd, int reg, uint8_t *values, uint8_t size)
{
  ...
  data.block[0] = size;
  int result = i2c_smbus_access (fd, 1, reg, 8, &data);
  if (result<0) {
    return result;
  }
...
{
  return i2c_smbus_access (fd, 0, data, 1, 
# 186 "ext_deps/wiringpi/wiringPiI2C.c" 3 4
                                                                     ((void *)0)
# 186 "ext_deps/wiringpi/wiringPiI2C.c"
                                                                         ) ;
}
# 196 "ext_deps/wiringpi/wiringPiI2C.c"
int wiringPiI2CWriteReg8 (int fd, int reg, int value)
{
  union i2c_smbus_data data ;

  data.byte = value ;
  return i2c_smbus_access (fd, 0, reg, 2, &data) ;
}
...
int wiringPiI2CWriteReg16 (int fd, int reg, int value)
{
  ...
  data.word = value ;
  return i2c_smbus_access (fd, 0, reg, 3, &data) ;
}
...
int wiringPiI2CWriteBlockData (int fd, int reg, const uint8_t *values, uint8_t size)
{
    ...
    return i2c_smbus_access (fd, 0, reg, 5, &data) ;
}
...
# 236 "ext_deps/wiringpi/wiringPiI2C.c"
int wiringPiI2CSetupInterface (const char *device, int devId)
{
  int fd ;

  if ((fd = open (device, 
# 240 "ext_deps/wiringpi/wiringPiI2C.c" 3 4
                         02
# 240 "ext_deps/wiringpi/wiringPiI2C.c"
                               )) < 0)
    return wiringPiFailure ((1==2), "Unable to open I2C device: %s\n", strerror (
# 241 "ext_deps/wiringpi/wiringPiI2C.c" 3 4
                                                                                    (*__errno_location ())
# 241 "ext_deps/wiringpi/wiringPiI2C.c"
                                                                                         )) ;

  if (ioctl (fd, 0x0703, devId) < 0)
    return wiringPiFailure ((1==2), "Unable to select I2C device: %s\n", strerror (
# 244 "ext_deps/wiringpi/wiringPiI2C.c" 3 4
                                                                                      (*__errno_location ())
# 244 "ext_deps/wiringpi/wiringPiI2C.c"
                                                                                           )) ;

  return fd ;
}
# 256 "ext_deps/wiringpi/wiringPiI2C.c"
